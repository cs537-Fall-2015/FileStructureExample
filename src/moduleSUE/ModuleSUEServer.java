...
public class ModuleSUEServer extends RoverServerRunnable {

	public ModuleSUEServer(int port) throws IOException {
		super(port);
	}
	...
	public void run() {
		...
		SUE moduleTwoClass = new SUE(2);
		
		try {
			
			while (true) {
				
				System.out.println("Module SUE Server: Waiting for client request");
				...
				System.out.println("Module SUE Server: Message Received from Client - "+ message.toUpperCase());
				
				// create ObjectOutputStream object
				ObjectOutputStream outputToAnotherObject = new ObjectOutputStream(getRoverServerSocket().getSocket().getOutputStream());
				
				// write object to Socket
				outputToAnotherObject.writeObject("Module SUE Server response Hi Client - " + message);
				...
				if (message.equalsIgnoreCase("exit"))
					...
					System.out.println("");
					System.out.println("<Server SUE>");
					System.out.println("This is Module SUE " + Constants.TWO + "'s object at the start");
					...
					System.out.println("");
					System.out.println("<Start> Module SUE Server Receiving <Start>");
					System.out.println("===========================================");
					System.out.println("This is Class SUE " + Constants.ONE + "'s object ");
					...
					System.out.println("===========================================");
					System.out.println("<End> Module SUE Server Receiving <End>");
					System.out.println("");
				}
			}
			System.out.println("Server SUE: Shutting down Socket server 2!!");
			...
			System.out.println("Server SUE: Error: " + error.getMessage());
		}
