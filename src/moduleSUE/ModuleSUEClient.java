...
public class ModuleSUEClient extends RoverClientRunnable{

	public ModuleSUEClient(int port, InetAddress host)
	...
	public void run() {
		try{
	        ...
	        for(int i = 0; i < 4; i++){
	            ...
	            //System.out.println("=================================================");
	            System.out.println("Module SUE Client: Sending request to Socket Server");
	            //System.out.println("=================================================");
	            ...
	            System.out.println("Module SUE Client: Message from Server - " + message.toUpperCase());
	            
	            // The server sends us a JSON String here
	            String jsonString = (String) inputFromAnotherObject.readObject();
	            System.out.println("Module SUE Client: Message from Server - " + jsonString.toUpperCase());
				...
				System.out.println("");
				System.out.println("<Start> Client SUE now has: <Start>");
				System.out.println("===========================================");
				...
				System.out.println("===========================================");
				System.out.println("<End> Client SUE now has: <End>");
				System.out.println("");
			...
			System.out.println("Client SUE: Error:" + error.getMessage());
		}
