...
//
//public class RoverControlServer extends RoverServerRunnable {
//
//	public RoverControlServer(int port) throws IOException {
//		super(port);
//	}
//
//	@Override
//	public void run() {
//		
//		RoverControlModule moduleTwoClass = new RoverControlModule(2);
//		
//		try {
//			
//			while (true) {
//				
//				System.out.println("Rover Control Server: Waiting for client request");
//				
...
//				System.out.println("Rover Control Server: Message Received from Client - "+ message.toUpperCase());
//				
//				// create ObjectOutputStream object
//				ObjectOutputStream outputToAnotherObject = new ObjectOutputStream(getRoverServerSocket().getSocket().getOutputStream());
//				
//				// write object to Socket
//				outputToAnotherObject.writeObject("Rover Control Server response Hi Client - " + message);
//				
...
//					break;
//				else if(message.equalsIgnoreCase("ROVER_CONTROL_MODULE_PRINT")) {
//					// The server prints out its own object
//					System.out.println("");
//					System.out.println("<Rover Control Server>");
//					System.out.println("This is Rover Control Module " + Constants.TWO + "'s object at the start");
...
//					
//					System.out.println("");
//					System.out.println("<Start> Rover Control Module Server Receiving <Start>");
//					System.out.println("===========================================");
...
//					System.out.println("===========================================");
//					System.out.println("<End> Rover Control Module Server Receiving <End>");
//					System.out.println("");
//				}
//			}
//			System.out.println("Rover Control Server: Shutting down Socket server 2!!");
...
//			System.out.println("Rover Control Server: Error: " + error.getMessage());
//		}
//
//	}
//
