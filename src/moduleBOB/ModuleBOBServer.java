...
public class ModuleBOBServer extends RoverServerRunnable {

	public ModuleBOBServer(int port) throws IOException {
		super(port);
	}
	...
	public void run() {
		...
		BOB moduleTwoClass = new BOB(2);
		
		try {
			
			while (true) {
				
				System.out.println("Module BOB Server: Waiting for client request");
				...
				System.out.println("Module BOB Server: Message Received from Client - "+ message.toUpperCase());
				
				// create ObjectOutputStream object
				ObjectOutputStream outputToAnotherObject = new ObjectOutputStream(getRoverServerSocket().getSocket().getOutputStream());
				
				// write object to Socket
				outputToAnotherObject.writeObject("Module BOB Server response Hi Client - " + message);
				...
				if (message.equalsIgnoreCase("exit"))
					...
					System.out.println("");
					System.out.println("<Server BOB>");
					System.out.println("This is module BOB " + Constants.TWO + "'s object at the start");
					moduleTwoClass.printObject();
					System.out.println("<Server BOB>");
					System.out.println("");
				}
				else if(message.equalsIgnoreCase("MODULE_BOB_DO_SOMETHING")) {
				...
				else if(message.equalsIgnoreCase("MODULE_BOB_GET")) {
					...
					System.out.println("");
					System.out.println("<Start> Module BOB Server Receiving <Start>");
					System.out.println("===========================================");
					System.out.println("This is Class BOB " + Constants.ONE + "'s object ");
					...
					System.out.println("===========================================");
					System.out.println("<End> Module BOB Server Receiving <End>");
					System.out.println("");
				}
			}
			System.out.println("Server: Shutting down Socket Server BOB!!");
			...
			System.out.println("Server BOB: Error: " + error.getMessage());
		}
