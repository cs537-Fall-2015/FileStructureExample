...
public class ModuleBOBClient extends RoverClientRunnable{

	public ModuleBOBClient(int port, InetAddress host)
	...
	public void run() {
		try{
	        ...
	        for(int i = 0; i < 4; i++){
	            ...
	            //System.out.println("=================================================");
	            System.out.println("Module BOB Client: Sending request to Socket Server");
	            //System.out.println("=================================================");
	            ...
	            if(i == 3){
	            	...
	            	outputToAnotherObject.writeObject("MODULE_BOB_GET");
	            }
	            else if(i == 1) {
	            ...
	            System.out.println("Module BOB Client: Message from Server - " + message.toUpperCase());
	            
	            // The server sends us a JSON String here
	            String jsonString = (String) inputFromAnotherObject.readObject();
	            System.out.println("Module BOB Client: Message from Server - " + jsonString.toUpperCase());
				...
				System.out.println("");
				System.out.println("<Start> Client BOB now has: <Start>");
				System.out.println("===========================================");
				...
				System.out.println("===========================================");
				System.out.println("<End> Client BOB now has: <End>");
				System.out.println("");
			...
			System.out.println("Client BOB: Error:" + error.getMessage());
		}
